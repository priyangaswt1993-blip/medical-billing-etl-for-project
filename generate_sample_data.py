...
Creates a small, deliberately MESSY sample healthcare billing dataset
(raw_billing_data.csv) so we have something realistic to clean up in
the ETL pipeline. In a real project, this would be your source system
export (e.g., from a billing software or hospital database).
"""
